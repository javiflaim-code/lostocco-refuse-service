...
export function SiteFooter() {
  return (
    <footer className="on-forest bg-ink text-mint">
      <div className="wrap grid gap-10 py-14 sm:grid-cols-2 md:grid-cols-[1.2fr_1fr_1fr_1.1fr] md:gap-8 md:py-16">
        <div className="flex flex-col gap-4">
          <div className="display flex flex-col leading-none text-paper">
        ...
        <nav aria-label="Footer" className="flex flex-col gap-3">
          ...
          <ul className="flex flex-col gap-2">
            <li>
              <Link
                href="/"
                className="inline-flex min-h-[44px] items-center text-[0.9375rem] text-mint/85 hover:text-amber"
              >
                Home
              </Link>
            </li>
      ...
      <div className="border-t-[3px] border-mint/20">
        <div className="wrap flex flex-col items-center gap-6 py-8 sm:flex-row sm:items-end sm:justify-between">
          <div className="flex items-end gap-4">
            <Image
              ...
              sizes="120px"
              className="h-auto w-[92px] shrink-0 xs:w-[120px]"
            />
